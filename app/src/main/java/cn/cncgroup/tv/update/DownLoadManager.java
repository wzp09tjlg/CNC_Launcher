...
import cn.cncgroup.tv.update.dbcontrol.DataKeeper;
...
public class DownLoadManager {
    ...
    private final int MAX_DOWNLOADING_TASK = 1; // 最大同时下载数
    ...
    private void init(Context context) {
        ...
        userID = sharedPreferences.getString("UserID", "CNC");
