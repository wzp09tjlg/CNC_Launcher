...
/**
 * Created by zhang on 2015/11/19.
 */
/*
...
public abstract class FragmentPagerAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        String name = makeFragmentName(container.getId(), getPageTitle(position), itemId);
        ...
        if (fragment != null) {
            ...
            mCurTransaction.add(container.getId(), fragment,
                    makeFragmentName(container.getId(), getPageTitle(position), itemId));
        }
    ...
    private static String makeFragmentName(int viewId, CharSequence title, long id) {
        return "android:switcher:" + viewId + ":" + title + ":" + id;
    }
}
