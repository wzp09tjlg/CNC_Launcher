...
public class GridVerticalAdapter extends RecyclerView.Adapter<GridVerticalAdapter.ViewHolder> {
    ...
    public GridVerticalAdapter(OnItemClickListener<VideoSet> clickListener, OnItemFocusListener<VideoSet> focusListener, boolean isLoadImage) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == 0) {
            return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_grid_vertical_all, parent, false));
        } else {
            return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_grid_vertical, parent, false));
        }
    }
